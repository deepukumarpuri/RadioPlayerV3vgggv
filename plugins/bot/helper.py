...
HOME_TEXT = "👋🏻 **Hi [{}](tg://user?id={})**,\n\nI'm **Radio Player V3.0** \nI Can Play Radio / Music / YouTube Live In Channel & Group 24x7 Nonstop. Made with ❤️ By @DKBOTZ 😉!"
HELP_TEXT = """
🏷️ --**Setting Up**-- :
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data == "replay":
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton("BOT CHANNEL", url="https://t.me/DKBOTZ"),
                InlineKeyboardButton("SUPPORT GROUP", url="https://t.me/DK_BOTZ"),
            ],
            [
                InlineKeyboardButton("MORE BOTS", url="https://t.me/DKBOTZ/300"),
...
async def start(client, message):
    ...
    reply_markup = InlineKeyboardMarkup(buttons)
    m=await message.reply_photo(photo="https://telegra.ph/file/ed4b7c4e5e4ca5ce97930.jpg", caption=HOME_TEXT.format(message.from_user.first_name, message.from_user.id), reply_markup=reply_markup)
    await mp.delete(m)
...
async def help(client, message):
    ...
    msg['help'] = await message.reply_photo(photo="https://telegra.ph/file/ed4b7c4e5e4ca5ce97930.jpg", caption=HELP_TEXT, reply_markup=reply_markup)
    await mp.delete(message)
